    ...
    <section className="min-h-screen py-16 sm:py-20 px-4">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 mb-6 shadow-xs">
        ...
        <div className="grid gap-4">
          {imageTools.map((tool) => (
            <Link key={tool.href} href={tool.href} className="group block">
              <div className="flex items-center gap-6 p-6 rounded-2xl border border-zinc-200/80 dark:border-white/10 bg-white/70 dark:bg-zinc-900/50 hover:border-emerald-500/30 hover:bg-white/95 dark:hover:bg-zinc-900/80 hover:-translate-y-0.5 transition-all duration-300 shadow-xs backdrop-blur-md">
                <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center">
                  <tool.icon className="h-5 w-5 text-emerald-600 dark:text-emerald-400" />
                </div>
                ...
                <ArrowRight className="h-5 w-5 text-zinc-400 group-hover:text-emerald-600 dark:text-zinc-600 dark:group-hover:text-emerald-400 group-hover:translate-x-1 transition-all duration-300" />
              </div>
            </Link>
          ))}
        </div>
