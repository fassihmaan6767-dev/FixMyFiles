    ...
    <section className="min-h-screen py-24 px-4">
      <div className="mx-auto max-w-4xl">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white mb-4">PDF Tools</h1>
        ...
        <div className="grid gap-4">
          {pdfTools.map((tool) => (
            <Link key={tool.href} href={tool.href} className="group block">
              <div className="flex items-center gap-6 p-6 rounded-2xl border border-white/10 bg-zinc-900/50 hover:border-orange-500/30 hover:bg-zinc-900/80 hover:-translate-y-0.5 transition-all duration-300">
                ...
                <ArrowRight className="h-5 w-5 text-zinc-600 group-hover:text-orange-400 group-hover:translate-x-1 transition-all duration-300" />
              </div>
            </Link>
          ))}
        </div>
